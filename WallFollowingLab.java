...
public class WallFollowingLab {
  ...
  // Speed of the faster rotating wheel (deg/seec)
  private static final int ClosestDistanceRotate= 11;
  ...
  public static void main(String[] args) {
    ...
    BangBangController bangbangController =
        new BangBangController(bandCenter, bandWidth, motorLow, motorHigh, ClosestDistanceRotate);

    PController pController = new PController(bandCenter, bandWidth, ClosestDistanceRotate);
...
public static int getClosestDistanceRotate() {
	return ClosestDistanceRotate;
}
}
